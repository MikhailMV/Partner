...
$arSecondIBlockType = CIBlockParameters::GetIBlockTypes();

$arSecondIBlock = array();
$iblockFilter = (
	!empty($arCurrentValues['SECOND_IBLOCK_TYPE'])
	? array('TYPE' => $arCurrentValues['SECOND_IBLOCK_TYPE'], 'ACTIVE' => 'Y')
	: array('ACTIVE' => 'Y')
);
$rsIBlock = CIBlock::GetList(array('SORT' => 'ASC'), $iblockFilter);
while ($arr = $rsIBlock->Fetch())
	$arSecondIBlock[$arr['ID']] = '['.$arr['ID'].'] '.$arr['NAME'];
