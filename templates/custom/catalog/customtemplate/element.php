...
<?
// Отобразить информацию о партнере
if ($arResult['PARTNER_NAME'] and $arResult['PARTNER_DESCRIPTION'] and $arResult['PARTNER_CONDITION'])
{    
	print('<b>'.'Партнер товара: '.'</b>'.$arResult['PARTNER_NAME'].'<br>');
	print('<b>'.'Описание партнера: '.'</b>'.$arResult['PARTNER_DESCRIPTION'].'<br>');
	print('<b>'.'Условия доставки: '.'</b>'.$arResult['PARTNER_CONDITION'].'<br>');
} 
?>
<?
